...
public class RabbitAdvertisementConfig {
    ...
    @Bean
    public Binding advertisementBinding(@Qualifier("notificationAdvertisementQueue") Queue notificationAdvertisementQueue,
                                        @Qualifier("fanoutAdvertisementExchange") FanoutExchange fanoutAdvertisementExchange) {
